...
public class NexmarkConfiguration implements Serializable {
  ...
  @JsonProperty public int avgPersonByteSize = 100;

  /** Average idealized size of a 'new auction' event, in bytes. */
  @JsonProperty public int avgAuctionByteSize = 250;

  /** Average idealized size of a 'bid' event, in bytes. */
  @JsonProperty public int avgBidByteSize = 50;
  ...
  @JsonProperty public int incStep = 5;
  ...
  public String toShortString() {
    ...
    if (incStep != DEFAULT.incStep) {
      sb.append(String.format("; incStep:%d", incStep));
    }
